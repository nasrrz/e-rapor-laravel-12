...
@section('content')
    <div class="space-y-6">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="mt-1 text-sm text-gray-500">Daftar semua tahun akademik beserta status keaktifannya.</p>
            </div>
                                ...
                                @forelse($academicYears as $year)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            {{ $year->semester == 'odd' ? 'Ganjil' : 'Genap' }}
                                        </td>
